...
- **Analyze and Transcribe:** Accurately transcribe audio and analyze visual information (UI elements, clicks, inputs, on-screen changes) to create a chronological sequence of steps.
...
- **Input Video:** You have just analyzed a screen recording named "${fileName}".
- **Video Transcription:** The following is a transcription of the audio from the video. Use this as a key reference for the steps being performed, but also rely on your visual analysis of the video to supplement the information.
\`\`\`
